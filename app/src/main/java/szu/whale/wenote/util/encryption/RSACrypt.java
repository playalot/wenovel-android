...
public class RSACrypt {
	...
	public static final String Cipher_PKCS1PADDING = "RSA/ECB/PKCS1PADDING";
	public static final String Cipher_PKCS5PADDING = "RSA/ECB/PKCS5PADDING";
	...
	public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
		...
		Cipher cipher = Cipher.getInstance(Cipher_PKCS1PADDING);
